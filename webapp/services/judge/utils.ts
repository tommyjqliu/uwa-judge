...
export function isJudgeTaskFinished(judgeTask: JudgeTask) {
    return judgeTask.runResult !== null || (judgeTask.compileSuccess !== null && !judgeTask.compileSuccess);
}

export function isJudgeTaskError(judgeTask: JudgeTask) {
    return judgeTask.runResult !== null && judgeTask.runResult !== 'correct' || (judgeTask.compileSuccess !== null && !judgeTask.compileSuccess);
}
...
export async function isJudgeFinished(judge: Judge & { judgeTask: JudgeTask[] }) {
