...
export default function ProblemTabs({
  ...
  const [grade, setGrade] = useState(
    initialGrade ? initialGrade.toString() : "",
  );
  ...
  const latestSubmission =
    selectedProblem.submission.length > 0
      ? selectedProblem.submission[0]
      : null;
        ...
        <CardContent>
          {judgeResults && (
            <div className="mb-4 text-sm">
              ...
              <p className="mb-4">
                <span className="font-semibold">Number of Tests:</span>{" "}
                {judgeResults.total}
              </p>
              <div className="mb-2">
                ...
                <div className="mb-2">
                  <div className="border border-red-500 rounded-md p-2 inline-block">
                    <p className="text-red-600">
                      ...
                      {judgeResults.total - judgeResults.pass}
                    </p>
                  </div>
                </div>
              )}
          ...
          {latestSubmission ? (
            ...
            <p className="text-gray-600">
              No submission available for this problem by the selected student.
            </p>
          )}
        </CardContent>
      </Card>
