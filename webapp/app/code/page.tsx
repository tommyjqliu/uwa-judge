			...
			{problemVersion && <>
				<ResizablePanel defaultSize={50} id="statement">
					<div className="flex flex-col items-center justify-center h-full">
						...
						<PdfReader url={`api/problem-versions/${problemVersion.id}/pdf-statement`} className="border-2 border-gray-300" />
					</div>
				</ResizablePanel>
				<ResizableHandle withHandle />
			</>}
			<ProblemSolver problemVersionId={problemVersionId} problemId={problemId} />
		</ResizablePanelGroup>
	)
}