...
import { RuntimeClient, UWAjudgeDB, domjudgeDB, uwajudgeDB } from '@/lib/database-client';
...
export async function uploadProblemToDomjudge(file: File) {
    ...
    await problemsApi.postV4AppApiProblemAddproblemForm(newFile, '', String(CONTEST_CID));
