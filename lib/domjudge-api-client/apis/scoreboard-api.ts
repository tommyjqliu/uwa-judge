 ...
 * @export
 */
export const ScoreboardApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getV4AppApiScoreboardGetscoreboard: async (
      cid: string,
      allteams?: boolean,
      category?: number,
      country?: string,
      ...
      if (cid === null || cid === undefined) {
        throw new RequiredError(
          "cid",
          "Required parameter cid was null or undefined when calling getV4AppApiScoreboardGetscoreboard.",
        );
      }
      const localVarPath = `/api/v4/contests/{cid}/scoreboard`.replace(
        `{${"cid"}}`,
...
export const ScoreboardApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async getV4AppApiScoreboardGetscoreboard(
      cid: string,
      allteams?: boolean,
      category?: number,
      country?: string,
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => Promise<AxiosResponse<Scoreboard>>
    > {
      const localVarAxiosArgs = await ScoreboardApiAxiosParamCreator(
        configuration,
      ).getV4AppApiScoreboardGetscoreboard(
        cid,
        allteams,
        category,
        country,
 ...
 * @export
 */
export const ScoreboardApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  return {
    ...
    async getV4AppApiScoreboardGetscoreboard(
      ...
      return ScoreboardApiFp(configuration)
        .getV4AppApiScoreboardGetscoreboard(
          cid,
          allteams,
          category,
...
export class ScoreboardApi extends BaseAPI {
   ...
   */
  public async getV4AppApiScoreboardGetscoreboard(
    cid: string,
    allteams?: boolean,
    category?: number,
    country?: string,
    ...
    return ScoreboardApiFp(this.configuration)
      .getV4AppApiScoreboardGetscoreboard(
        cid,
        allteams,
        category,
