 ...
 * @export
 */
export const JudgementsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
        ...
        getV4AppApiJudgementList: async (cid: string, ids?: Array<string>, result?: string, submissionId?: string, strict?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v4/contests/{cid}/judgements`
        ...
        getV4AppApiJudgementList1: async (cid: string, ids?: Array<string>, result?: string, submissionId?: string, strict?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v4/judgements`
                .replace(`{${"cid"}}`, encodeURIComponent(String(cid)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getV4AppApiJudgementSingle: async (id: string, cid: string, strict?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getV4AppApiJudgementSingle.');
            }
            // verify required parameter 'cid' is not null or undefined
            if (cid === null || cid === undefined) {
                throw new RequiredError('cid','Required parameter cid was null or undefined when calling getV4AppApiJudgementSingle.');
            }
         ...
         * @throws {RequiredError}
         */
        getV4AppApiJudgementSingle1: async (id: string, cid: string, strict?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getV4AppApiJudgementSingle1.');
            }
            // verify required parameter 'cid' is not null or undefined
            if (cid === null || cid === undefined) {
                throw new RequiredError('cid','Required parameter cid was null or undefined when calling getV4AppApiJudgementSingle1.');
            }
...
export const JudgementsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getV4AppApiJudgementSingle(id: string, cid: string, strict?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse2009>>> {
            const localVarAxiosArgs = await JudgementsApiAxiosParamCreator(configuration).getV4AppApiJudgementSingle(id, cid, strict, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getV4AppApiJudgementSingle1(id: string, cid: string, strict?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse2009>>> {
            const localVarAxiosArgs = await JudgementsApiAxiosParamCreator(configuration).getV4AppApiJudgementSingle1(id, cid, strict, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const JudgementsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * 
         * @summary Get all the judgements for this contest.
         ...
         * @throws {RequiredError}
         */
        async getV4AppApiJudgementSingle(id: string, cid: string, strict?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse2009>> {
            return JudgementsApiFp(configuration).getV4AppApiJudgementSingle(id, cid, strict, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get the given judgement for this contest.
         ...
         * @throws {RequiredError}
         */
        async getV4AppApiJudgementSingle1(id: string, cid: string, strict?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse2009>> {
            return JudgementsApiFp(configuration).getV4AppApiJudgementSingle1(id, cid, strict, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class JudgementsApi extends BaseAPI {
     ...
     * @memberof JudgementsApi
     */
    public async getV4AppApiJudgementSingle(id: string, cid: string, strict?: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse2009>> {
        return JudgementsApiFp(this.configuration).getV4AppApiJudgementSingle(id, cid, strict, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Get the given judgement for this contest.
     ...
     * @memberof JudgementsApi
     */
    public async getV4AppApiJudgementSingle1(id: string, cid: string, strict?: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse2009>> {
        return JudgementsApiFp(this.configuration).getV4AppApiJudgementSingle1(id, cid, strict, options).then((request) => request(this.axios, this.basePath));
    }
}
