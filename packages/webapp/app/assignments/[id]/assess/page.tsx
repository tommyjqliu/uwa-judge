                  ...
                  <ul className="list-disc list-inside">
                    {assignment.tutors.map((tutorAssignment) => (
                      <li key={tutorAssignment.user.id}>
                        {tutorAssignment.user.username ||
                          tutorAssignment.user.email}
                      </li>
                    ))}
                  </ul>
                ) : (
              ...
              <tbody>
                {assignment.students.map((studentAssignment) => {
                  ...
                  const studentGrade = studentGrades.find(
                    (grade) => grade.studentId === studentAssignment.user.id,
                  )?.mark;
                  const assessment = studentGrades.find(
                    (grade) => grade.studentId === studentAssignment.user.id,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 border-b text-center">
                        <Link
                          href={`/assignments/${assignmentId}/assess/${studentAssignment.user.id}/submission`}
                        >
